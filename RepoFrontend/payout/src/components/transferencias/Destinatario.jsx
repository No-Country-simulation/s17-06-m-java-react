...
const Destinatario = () => {
    ...
    return (
        <section className='flex flex-col w-full items-center h-full justify-center md:justify-start mt-[8rem] gap-2 md:mt-10'>
            ...
            <div className="flex flex-col items-center bg-white md:bg-grisclaro md:bg-white justify-center p-3 md:justify-between">
            ...
            <button onClick={handleContinuar} className='flex items-center justify-between bg-white text-primario w-[80vw] md:w-[50vw] h-full md:h-[20vh] p-4 text-start'>
                <div className="flex gap-4 items-center">
